...
extension FirebaseUserX on _.User {
  User domain() {
    return User.firebaseAuth(
      ...
      displayName: displayName ?? providerData.firstWhere((info) => info?.displayName != null || info?.displayName != "", orElse: null).displayName,
      email: email ?? providerData.firstWhere((info) => info?.email != null || info?.email != "", orElse: null).email,
      isEmailVerified: emailVerified,
      phone: phoneNumber ?? providerData.firstWhere((info) => info?.phoneNumber != null || info?.phoneNumber != "", orElse: null).phoneNumber,
