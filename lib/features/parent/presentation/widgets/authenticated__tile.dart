...
class AuthenticatedProfileTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<StudentAuthCubit, StudentAuthState>(
      builder: (context, _) {
        var state = context.bloc<StudentAuthCubit>().state;
                ...
                children: [
                  ...
                  Expanded(
                    ...
                    child: Column(
                      ...
                      children: [
                        holder(
                          AutoSizeText("${state.student?.displayName?.getOrEmpty}",
                        ...
                        //
                        holder(AutoSizeText("${state.student?.email?.getOrEmpty}", style: TextStyle(fontSize: 17.0))),
                      ],
                    ),
                  ),
                ],
